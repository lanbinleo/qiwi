...
$sidebarAnnouncementHtml = function_exists('qiwiRenderSidebarAnnouncement') ? qiwiRenderSidebarAnnouncement($this) : '';
...
<?php if ($sidebarAnnouncementHtml !== ''): ?>
<div class="sidebar-section sidebar-announcement" aria-label="公告">
    <h3 class="sidebar-title">公告</h3>
    <div class="sidebar-announcement-body">
        <?php echo $sidebarAnnouncementHtml; ?>
    </div>
</div>
<?php endif; ?>
