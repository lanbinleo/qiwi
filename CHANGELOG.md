...
- Plog 页面模式由管理员在正文里选择，支持网格、瀑布流、画廊和时间流四种展示方式。
- Plog 图片按上传日期倒序展示，支持 timestamp、`2026-06-15`、`2026/06/15`、`2026.06.15`、`20260615 19:50` 等日期写法。
- 后台新增“页面模板”tab，提供 Plog 正文模板一键复制。
