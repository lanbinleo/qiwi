...
- 扩展正文短代码组件，新增 `[badge]`、`[callout]`、`[button]` 与 `[buttons]`。
...
- 重做首页侧边栏个人信息区，导航栏头像与侧边栏头像/文字/社交链接拆分配置，并支持 GitHub、Bilibili、Email、RSS 简约图标。
...
- 开发说明：本版本仍在 `dev/1.4.0` 分支中，暂未更新 `update.json` 发布元数据。
